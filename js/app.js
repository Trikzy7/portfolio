...
//#region SLIDER 2
    ...
    create('p', container_education1, '2020 - Today', 'education_date') ;

    let container_education_info1 = create('div', container_education1, null,  'container_education_info');
    create('p', container_education_info1, 'DUT INFO', 'education_diploma') ;
    create('p', container_education_info1, 'IUT - University of Savoie - Annecy, France', 'education_location') ;
    create('p', container_education_info1, 'University diploma of technology specialized in computer science. (2 years)', 'education_descr') ;
    ...
    create('p', container_education2, '2017 - 2020', 'education_date') ;

    let container_education_info2 = create('div', container_education2, null,  'container_education_info');
    create('p', container_education_info2, 'Baccalaureat S SVT/INF', 'education_diploma') ;
    create('p', container_education_info2, 'High School - Montceau-les-Mines, France', 'education_location') ;
    create('p', container_education_info2, 'High school diploma in science and computer science ', 'education_descr') ;
